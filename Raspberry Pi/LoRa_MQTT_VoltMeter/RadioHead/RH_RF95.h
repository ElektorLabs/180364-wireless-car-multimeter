...
public:
    ...
    /// Reinitialise the hardware and software.
    /// This will restore the LoRa configuration
    /// \return true if initialisation succeeded.
    bool    reinit();
